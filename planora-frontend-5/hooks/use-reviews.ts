...
//         `${process.env.NEXT_PUBLIC_API_URL}/api/v1/events/${eventId}/reviews${qs ? `?${qs}` : ""}`,
//       ),
//     enabled: !!eventId,
//   });
// }
...
//     queryFn: () =>
//       apiFetch<ReviewListResponse>(
//         `${process.env.NEXT_PUBLIC_API_URL}/api/v1/reviews/my${qs ? `?${qs}` : ""}`,
//       ),
//   });
// }
...
//       comment: string;
//     }) =>
//       apiFetch<unknown>(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/events/${eventId}/reviews`, {
//         method: "POST",
...
//       comment: string;
//     }) =>
//       apiFetch<unknown>(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/reviews/${reviewId}`, {
//         method: "PUT",
//         body: JSON.stringify({ rating, comment }),
//       }),
//     onSuccess: () => {
...
//       apiFetch<unknown>(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/reviews/${reviewId}`, { method: "DELETE" }),
//     onSuccess: () => {
//       queryClient.invalidateQueries({ queryKey: reviewKeys.all });
//       queryClient.invalidateQueries({ queryKey: eventKeys.all });
