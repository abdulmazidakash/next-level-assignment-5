...
//         `${process.env.NEXT_PUBLIC_API_URL}/api/v1/invitations/my${qs ? `?${qs}` : ""}`,
//       ),
//   });
// }
...
//       apiFetch<unknown>(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/events/${eventId}/invitations`, {
//         method: "POST",
...
//     }) =>
//       apiFetch<unknown>(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/invitations/${invitationId}/respond`, {
//         method: "POST",
