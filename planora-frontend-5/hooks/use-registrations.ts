...
//         `${process.env.NEXT_PUBLIC_API_URL}/api/v1/events/${eventId}/registrations${qs ? `?${qs}` : ""}`,
//       ),
...
//     queryFn: () =>
//       apiFetch<RegistrationListResponse>(
//         `${process.env.NEXT_PUBLIC_API_URL}/api/v1/registrations/my${qs ? `?${qs}` : ""}`,
//       ),
//   });
// }
...
//       apiFetch<JoinResponse>(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/events/${eventId}/registrations`, {
//         method: "POST",
//       }),
//     onSuccess: (data) => {
...
//     }) =>
//       apiFetch<unknown>(
//         `${process.env.NEXT_PUBLIC_API_URL}/api/v1/events/${eventId}/registrations/${registrationId}`,
//         {
//           method: "PATCH",
