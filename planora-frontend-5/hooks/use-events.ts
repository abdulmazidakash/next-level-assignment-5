...
//     queryFn: () =>
//       apiFetch<EventListResponse>(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/events${qs ? `?${qs}` : ""}`),
//   });
// }
...
//     queryFn: () => apiFetch<unknown>(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/events/${id}`),
//     enabled: !!id,
//   });
// }
...
//     queryFn: () =>
//       apiFetch<EventListResponse>(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/events/my${qs ? `?${qs}` : ""}`),
//   });
// }
...
//       }
//       return apiFetch<unknown>(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/events`, {
//         method: "POST",
...
//         payload.date = new Date(payload.date).toISOString();
//       }
//       return apiFetch<unknown>(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/events/${id}`, {
//         method: "PUT",
//         body: JSON.stringify(payload),
//       });
//     },
...
//       apiFetch<unknown>(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/events/${id}`, { method: "DELETE" }),
//     onSuccess: () => {
//       queryClient.invalidateQueries({ queryKey: eventKeys.all });
...
//     queryFn: () => apiFetch<FeaturedEvent | null>(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/events/featured`),
//   });
// }
